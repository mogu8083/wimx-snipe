...
//public class PacketHandler_20221228 extends ChannelInboundHandlerAdapter {
//
//	@Override
...
//
//					// Client 전송
//					byte[] b = device.toString().getBytes(StandardCharsets.UTF_8);
//					ChannelFuture future = ctx.writeAndFlush(Unpooled.wrappedBuffer(b));
//
//					if(future.isSuccess()) {
//						if(DevUtils.isPrint(deviceId)) {
//							log.info(deviceId + " - > isDone!");
//						}
//					}
//				}
//			}
