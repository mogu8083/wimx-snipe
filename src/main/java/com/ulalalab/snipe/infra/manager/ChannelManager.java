...
//     * 채널 삭제
//     */
////    public void removeChannel(short deviceIndex) throws Exception {
////
////        for (Channel channel : channelGroup.keySet()) {
////            ChannelInfo channelInfo = channelGroup.get(channel);
////            short channelDeviceIndex = channelInfo.getDeviceIndex();
////
////                if(channelDeviceIndex == deviceIndex) {
////                    log.info("{} DeviceId Client Channel Close!", channelInfo.getDeviceIndex());
////                    channel.close();
////                    channelGroup.remove(channel);
////                    break;
////                }
